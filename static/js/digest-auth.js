...
jQuery.Class("pl.arrowgroup.DigestAuthentication", {
  MAX_ATTEMPTS: 1,
  AUTHORIZATION_HEADER: "Authorization",
  WWW_AUTHENTICATE_HEADER: 'X-MMS-Authenticate',
...
jQuery.Class("pl.arrowgroup.HeaderParamsParser", {
  ...
  getParam: function (paramName) {
    var paramVal = null;
    jQuery.each(this.headerParams, function (index, value) {
